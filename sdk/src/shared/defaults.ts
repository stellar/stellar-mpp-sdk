 ...
 * channel state read at the same time. These reads run outside the cumulative
 * lock. This value is therefore the only limit on the number of RPC calls that
 * a burst of credentials can start.
 */
